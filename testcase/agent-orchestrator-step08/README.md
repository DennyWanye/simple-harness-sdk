...
- 真实模型（opt-in）：`--run-real-provider tests/orchestrator/step08/test_real_provider_evaluation.py`（`SH_MODEL=deepseek-flash`）；运行记录 `plans/.../step08/reports/real-evaluation-run1.md`
