...
- 测试：`test_provider_grant_rehandoff.py` 2 + `test_nested_compound_composition.py` 2；4 条变异全部 KILLED。full_target **2852 passed / 2 skipped**（上一段 2848/2，+4）；旧模式 step02/05/06/07/p34/p35 **560 passed / 13 skipped / 0 failed**；ruff 全清；`_new_mode` 19 处不变。详见 journal 第四部分 §2n。
