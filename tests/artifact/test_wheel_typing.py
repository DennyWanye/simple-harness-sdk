...
def test_installed_wheel_exposes_strict_agent_memory_and_manifest_types(
    ...
    consumer.write_text(
        ...
        "    ContextAssemblyDecision, ContextFragment, ContextFragmentBindingV2,\n"
        "    ContextRouteState,\n"
        ...
        "    RecallContextUseAuthorizationRequestV1, RecallContextUseReceiptV1,\n"
        "    RecallDecisionV4, RecallPageConfirmationGroupBindingV1, RecallPlan,\n"
        "    RecallPageSelectedItemBindingV1, RecallResultPageRequestV1,\n"
        "    RecallSelectedItemV4, TypedRecallResultV1,\n"
        ...
        "recall_selected_type: type[RecallSelectedItemV4] = RecallSelectedItemV4\n"
        "recall_result_type: type[TypedRecallResultV1] = TypedRecallResultV1\n"
        "recall_page_type: type[RecallResultPageRequestV1] = RecallResultPageRequestV1\n"
        "recall_page_selected_type: type[RecallPageSelectedItemBindingV1] = (\n"
        "    RecallPageSelectedItemBindingV1\n"
        ")\n"
        "recall_page_group_type: type[RecallPageConfirmationGroupBindingV1] = (\n"
        ...
        "fragment_binding_type: type[ContextFragmentBindingV2] = ContextFragmentBindingV2\n"
