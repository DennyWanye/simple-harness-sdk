...
记录 Simple Harness SDK 的架构生产事实。当前 source candidate 版本权威为 `0.6.0`；覆盖官方 Agent Memory v1、可信四元 identity、
...
2026-08-25 Tool/Capability：SDK 0.6.0 source 已提供三类 capability record、bounded search/describe、
...
仍 pin 已发布 0.4.0 wheel，直到 exact 0.6.0 candidate 完成 Host/真实 UI prepublish gate；source、release、
