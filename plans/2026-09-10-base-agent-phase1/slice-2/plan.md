...
> 执行期修订（2026-09-10）：见 `challenge-round-1.md` 的 17 条裁决与 `journal.md` §1——T7 锚点改为持久序号规则、T8 改为协作式取消、T10 删掉 capability 旋钮、T1 追加 `tool_call_ordinal_from` 与 `UNIQUE(owner_scope,creation_key)`、内核为空转 base_agent Run 释放权限。
...
| 任务 | AC1 BA12 | AC2 BA08 | AC3 BA09 | AC4 BA11 | AC5 BA03 | AC6 BA04 | AC7 BA02 | AC8 BA05 | AC9 BA10 | AC10 L3 | AC11 cancel | AC12 D7 | AC13 F-BA-1 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| T1 schema | ○ | | | | ○ | ○ | | | | | ○ | | |
| T2 队列 | | ● | | | | | | | | ○ | | | |
| T3 close | ● | | | | | | | | | | | | |
