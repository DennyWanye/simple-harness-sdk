...
2026-09-07。H079 vendor manifest指定源码f841098b11c40192f1ad6b5676148533567ba706；SDK自有稀疏树simple-harness-sdk-nullable-tool-schema/feat/nullable-tool-schema，无新环境。Host自有simple_harness-corpus-clock/feat/context-route-nullable基主2c02be03。旧H079制品/installed不改，建议后继0.7.10由主统一定版构建一次，本叶不造wheel。
...
expected_source_hash本来兼用于resume_existing，不能笼统称只属于workspace。memory_standalone无任务来源需求，应省略或给真实JSON null；不得使用非空假hash。将核当前guard对此组合的确切边界，不能仅拒reuse却接收独立假hash。
