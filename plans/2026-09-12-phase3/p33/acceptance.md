...
## 用户批准的当前验收载体调整（2026-09-12）

用户明确“先把功能处理好，UI测试直接代码启动UI环境”，并确认范围P3.1–P3.5、不含P3.6。P33-20及G原生矩阵当前使用真实Tauri开发UI＋源码backend＋deepseek-flash；业务预期、真实点击、引用质量与负向控制保持。原文安装App/冻结制品部分暂缓，单独保留未验证，不以源码UI结果覆盖安装包结论。
