...
## 2026-09-14 real512K multi-turn semantic and cold replay

PASS using immutable SDKdc2f156/source-snapshot-v33. Synthetic first/middle/end records, second turn changes eligibility condition; both outputs exactly match the independent expected JSON. Actual input520288 and521469tokens (second counter521470), outputs2664/664, total1045085reportedtokens, cache0. Both calls use deepseek-flash,8Koutputdefault/32Kceiling; second selection drops old journal range2..2 while preserving current requirements. Cold same-input replay returns exact answer/journal with zero additional calls. Probe42.987s/runner43.35s; prior no-network dry14.135s/14.48s. Raw Host `.local-test-evidence/2026-09-13/p33-g/long-history-real512-v1/summary.json`, SHA256814d22cf7554d7e52059900eb9db126080522a36003f005cf7cb27d4504885ee. Script imports SDK from immutable snapshot, despite wrapper recording live repository dirty P34 diff; live P34 instructions were not part of this runtime. This supplements prior real256K and controlled history/recovery tests; not original-source document quality or an UNKNOWN handoff test. LC2precontext compatibility and wholePhase3 remainOPEN.
