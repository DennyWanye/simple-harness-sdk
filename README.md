...
recall release, and applies the declared resource ownership policy.
...
Consumers do not call recall/release/write manually. The old query/sink split has been
